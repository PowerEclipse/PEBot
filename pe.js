...
bot.on("disconnected", function() {
  ...
  process.exit(0); // Disconnected announcements are not always an error, seeing that disconnections can be triggered by the user.
});
...
function init(token) {
  ...
  Logger.info("Loading PowerEclipse...");
