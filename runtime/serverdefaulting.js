...
exports.create = function(bot) {
  ...
  bot.createServer(bot.user.username + " Base Camp", "london", function(error, server) {
    if (server) {
      ...
      msgArray.push("There are some special commands that only work in this server, `setowner` for example if you're my master."); // TODO: Not yet actually, I haven't done that yet.
      msgArray.push("Thanks for choosing PowerEclipse as your framework, have fun!");
